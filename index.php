    ...
    <div class="col-md-4">
      ...
      <div class="card card-body">
        <form action="save_task.php" method="POST">
          ...
          <div class="form-group">
            <textarea name="description" rows="2" class="form-control" placeholder="UNIDADES"></textarea>
          </div>
           <div class="form-group">
            <textarea name="existencia" rows="2" class="form-control" placeholder="CANTIDAD"></textarea>
          </div>
